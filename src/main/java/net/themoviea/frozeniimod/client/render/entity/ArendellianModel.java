...
public class ArendellianModel extends EntityModel<ArendellianEntity> {
...
@Override
public void setAngles(ArendellianEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
