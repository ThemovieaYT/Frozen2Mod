...
public class ElsaEntityModel extends EntityModel<ElsaEntity> {
...
public ElsaEntityModel() 
{
		...
		field_178732_b.setTextureOffset(40, 32).addCuboid(-1.0F, -2.0F, -12.0F, 3.0F, 12.0F, 4.0F, 0.0F, false);
...
@Override
public void setAngles(ElsaEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
{
