...
public class ElsaRevengeGoal extends TrackTargetGoal
{
	private static final TargetPredicate VALID_AVOIDABLES_PREDICATE = (new TargetPredicate()).includeHidden().ignoreDistanceScalingFactor();
	   ...
	   public ElsaRevengeGoal(PathAwareEntity mob, Class<?>... noRevengeTypes) {
	      super(mob, true);
	   ...
	   public ElsaRevengeGoal setGroupRevenge(Class<?>... noHelpTypes) {
